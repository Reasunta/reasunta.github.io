...
const careers = [
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (Genealogy/Heraldry or History) (Int)",
            "Blather (Fel) or Charm (Fel)",
            "Command (Fel)",
            "Common Knowledge (any two) (Int)",
            "Gossip (Fel)",
            "Haggle (Fel)",
            "Perception (Int)",
            "Performer (Actor) (Fel)",
        ...
        "trappings": [
            "Ambassadors are representatives of their governments",
            "empowered to deal on behalf of their lands.As such",
            "they must look the part. Ambassadors must have several sets of superior noble’s garb",
            "and many also have valuable jewellery to enhance their ensemble. An ambassador should keep a contingent of guards (no fewer than six). Finally",
            "ambassadors are often quite wealthy and must have coin",
            "jewellery",
            "art objects",
            "property",
            "and so on worth no less than 1",
            "000 gc."
        ],
        "career_entries": [
            "Admiral",
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (Magic) (Int) or Intimidate (S)",
            "Channelling (WP)",
            "Common Knowledge (Kislev) (Int)",
            "Magical Sense (WP)",
            "Navigation (Int) or Perception (Int)",
            "Outdoor Survival (Int)",
            "Speak Arcane Language (Magick) (Int)",
            "Speak Language (Kislevarin) (Int)"
        ],
        "talents": [
        ...
        "trappings": [
            "Given the harsh conditions of their training",
            "apprentice witches need survival gear",
            "generally consisting of a sturdy suit of winter clothing",
            "a pack or sling bag",
            "a flask of kvas to warm their bones",
            "and a few days of rations."
        ],
        "career_entries": [
            "Any"
        ],
    ...
    },
    {
        ...
        "description": "(Core) Humans born with magical talent are dangerous and feared individuals. Daemons and disaster gather about an untrained Wizard. To deal with this threat the Empire sends such people away to join one of the eight Orders of Wizardry. During their apprenticeship young Wizards learn how to practice magic safely, and contemplate which Order they will eventually join. Some apprentices will be bound to serve the Wizard who uncovered their talents, whilst others adventure to garner enough money to pay for their tutelage at the Colleges of Magic. Elves are naturally magical, and do not need to attend these Human institutions, learning from their own lore masters instead. See Chapter 7: Magic of the Core Rulebook for more details on the Orders of Magic.",
        "main_profile": {
            "ws": {
                "value": 0,
                "label": "–"
    ...
    },
    {
        ...
        "skills": [
            ...
            "Perception",
            "Secret Language (Guild Tongue)",
            "Speak Language (Khazalid, Breton, or Tilean)",
            "Trade (any three)"
        ],
        "talents": [
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (History or Law, Strategy Tactics or Theology) (Int)",
            "Charm (Fel) or Intimidate (S)",
            "Command (Fel)",
            "Common Knowledge (Kislev or Troll Country) (Int)",
            "Gossip (Fel) or Outdoor Survival (Int)",
            "Haggle (Fel)",
            "Perception (Int)",
            "Ride (Ag)",
            "Speak Language (Kislevarin) (Int)"
        ...
        "trappings": [
            "An ataman must be a distinguished member of a Kislevite community. To stand out from the rest of their people",
            "atamans wield a bulava",
            "a ceremonial mace (Superior Hand Weapon) recognised as a symbol of authority throughout Kislev."
        ],
        "career_entries": [
            "Captain",
            "Horse Master",
    ...
    },
    {
        ...
        "description": "(RC) Badlanders, as the name suggests, live in the badlands of the Border Princes. These areas are often mazes of broken rock, containing little water and less life, and what life is present is unpalatable at best and hostile at worst. They have to travel constantly around the area to find food and water, which also makes it relatively easy for them to hide. A surprisingly high proportion of Badlanders have previous careers from which they are hiding; those who don’t tend to dream of doing something worth hiding from.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "skills": [
            ...
            "Animal Training (Fel)",
            "Charm Animal (Fel)",
            "Consume Alcohol (T) or Gossip (Fel)",
            "Perception (Int) or Performer (any one) (Fel)",
            "Speak Language (Kislevarin) (Int)"
        ],
        "talents": [
    ...
    },
    {
        ...
        "trappings": [
            "Any Six Weapons (all of Best Craftsmanship)",
            "Medium Armour (Mail Shirt and Leather Jack)"
        ],
        "career_entries": [
            "Assassin",
    ...
    },
    {
        ...
        "description": "(hack, cough) used to it. (cough) (Core) Charcoal Burners can be found in every village in the Empire. They burn wood to create charcoal, an important fuel for the winter months. Since their work is both dirty and potentially dangerous, they work outside their villages. The outskirts of the forest are best, as wood is easily accessible. This proximity to the forest also makes charcoal-burning dangerous work, since isolated parties of such men are easy prey for the malign creatures of the wood. A Charcoal- Burner camp always has weapons handy, even if they are nothing more than clubs cut from the nearby trees.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "trappings": [
            ...
            "Forged Document",
            "4 bottles of variously coloured water",
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (Law or Intimidate) (Int)",
            "Command (Fel)",
            "Common Knowledge (Kislev) (Int)",
            "Dodge Blow (Ag) or Shadowing (Ag)",
            "Follow Trail (Int)",
            "Perception (Int)",
            "Ride (Ag)",
            "Search (Int)"
        ...
        "trappings": [
            "Chekist are all identifiable by their black uniforms. Most wear leather jacks and leggings",
            "and they all have distinctive helmets. Chekist are armed with bronze-tipped cudgels (Hand Weapon) and ride black Kislevite horses equipped with saddle",
            "harness",
            "and saddlebags."
        ],
        "career_entries": [
    ...
    },
    {
        ...
        "trappings": [
            ...
            "one Dose of Poison *See Old World Armoury page 31 for details."
        ],
        "career_entries": [
            "Assassin",
            "Courtier",
    ...
    },
    {
        ...
        "description": "(Core) Courtiers surround the nobility at court, fawning over lieges and ladies in the hopes of getting ahead. They range from sycophants who desperately wish to please, to cunning schemers who seek the keys to wealth and prestige. Courtiers are frequently well-read and skilled public speakers, as they are often called upon to offer erudite opinions on a variety of subjects to their Noble patrons. No Courtier, no matter how clever, is ever fully secure in his position, as there is always another who desperately wants it and is willing to do nearly anything to get it. Female Courtiers are usually known as ladies-in-waiting.",
        "main_profile": {
            "ws": "++5%",
            "bs": {
                "value": 5,
    ...
    },
    {
        ...
        "skills": [
            "Animal Care (Int)",
            "Animal Training (Fel) or Charm Animal (Fel)",
            "Common Knowledge (Kislev or Troll Country) (Int)",
            "Follow Trail (Int)",
            "Navigation (Int)",
            "Outdoor Survival (Int)",
            "Perception (Int)",
            "Ride (Ag)",
            "Speak Language (Kislevarin or Ungol) (Int)"
        ],
        "talents": [
            "Orientation",
        ...
        "trappings": [
            "Drovers all have at least one herd dog and a Kislevite horse equipped with a saddle and harness. They use a lasso to round up errant herd animals. For personal equipment",
            "drovers always have several days of rations and a couple of skins for water or kvas",
            "as well as a yurta for shelter. The often dangerous environment necessitates some armour",
            "usually a leather jack and leggings."
        ],
        "career_entries": [
            "Coachman",
            "Horse Master",
    ...
    },
    {
        ...
        "description": "(Core) From acrobats to strongmen, from knife throwers to hypnotists, from dancers to ventriloquists, the Empire is full of Entertainers. Some do it for the roar of the crowd and others for the money. Many become Entertainers just to escape the hard life of the Imperial villager. Entertainers travel frequently, sometimes alone but more often in troupes that perform in villages, towns, and cities. Lucky troupes get continuous bookings, sometimes spending months in the same city. The less fortunate scrape by as they can, always looking for a more appreciative crowd (or a less suspicious watch) over the next hill. The very best Entertainers gain Noble sponsorship and earn undreamed of sums of money performing for the upper crust.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "description": "(Core) The elder members of the great Elven mercantile families are far removed from the everyday life of the Empire. To them, Humans live and die so quickly that it’s hard to keep up with current trends and politics in the Old World. When they need such knowledge, they turn to their Envoys. These young Elves are the public face of the Merchant Houses. They negotiate the contracts, make the deals, and keep the peace with the Humans of trading hubs such as Altdorf, Nuln, and Marienburg. Even Elves have a limit to their patience, so it is unsurprising that many Envoys take leave of their families for the adventurer’s life.",
        "requirements": "Note: Only Elves can enter this career.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
        ...
        "trappings": [
            "Light Armour (Leather Jack)",
            "2 sets of Good Craftsmenship Clothes",
            "Writing Kit"
        ],
        "career_entries": [
            "Student",
    ...
    },
    {
        ...
        "trappings": [
            "Foil or Rapier",
            "One set of Best Craftsmenship Clothes",
            "Perfume or Cologne",
            "Healing Draught"
        ],
        "career_entries": [
    ...
    },
    {
        ...
        "skills": [
            "Charm",
            "Common Knowledge (the Empire)",
            "Evaluate or Secret Language (Ranger Tongue)",
            "Gossip or Intimidate",
            "Haggle",
            "Perception",
            "Row",
    ...
    },
    {
        ...
        "talents": [
            "Fearless",
            "Specialist Weapon Group (Flail or Two-handed Weapon)",
            "Strike Mighty Blow"
        ],
        "trappings": [
            "Flail or Great Weapon",
    ...
    },
    {
        ...
        "description": "(ToC) One of the greatest rewards a Jarl may grant to his Bondsmen and loyal Peasants is land. Upon gaining property, these men and women are accorded a special status. For those who were not warriors, they have the same status as Bondsmen. For those who were once warriors, land is usually a gift given in exchange for lengthy and valued service. Many Freeholders eventually become Jarls if selected by their King. Otherwise, they gain a piece of land and a number of Thralls to work it.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "description": "(SH) Gamblers eschew the hard work of the lower and middle classes. After all, why toil for such small rewards when a month’s income can be made with one well-played hand? Gamblers use their skill at games of chance to make money from the wealthy and the slow-witted. They haunt coaching inns and game houses, ready to part the gullible from their coins. Sometimes things go wrong and gamblers lose large sums of money. In these cases, a swift escape is in order, before the creditors discover that the debts can’t be paid. Gamblers tend to be drifters by nature, always moving on to avoid old debts and sore losers.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (Genealogy/Heraldry) Academic Knowledge (Religion)",
            "Academic Knowledge (Strategy/Tactics)",
            "Charm",
            "Command",
            "Common Knowledge (Bretonnia)",
    ...
    },
    {
        ...
        "description": "(RotIQ) The legendary hag mothers are very powerful hag witches, known for their powers of divination, healing, and their influence over the Ancient Widow’s spirits. Most eke out simple lives in rustic huts far from the communities they watch over. These hag mothers rarely leave their haunted homes, forcing those seeking their aid to undertake arduous journeys to reach them. However, a few hag mothers do wander Kislev, following wherever the spirits lead them and sharing their knowledge. Although most appear impossibly old and bent – their twisted spines creaking alarmingly at the smallest movement – many retain their youthful vigour and can be unexpectedly spry.",
        "requirements": "Special Requirements: You must be an Ungol female to enter this career.",
        "main_profile": {
            "ws": "—",
            "bs": "—",
            "s": {
        ...
        "skills": [
            "Academic Knowledge (Daemonology or Spirits, History or Necromancy, plus any one) (Int)",
            "Animal Care (Int)",
            "Charm Animal (Fel)",
            "Command (Fel)",
            "Common Knowledge (Kislev or Troll Country, plus any one) (Int)",
            "Heal (Int) or Prepare Poison (Int)",
            "Intimidate (S)",
            "Magical Sense (WP)",
            "Perception (Int)",
            "Speak Arcane Language (Magick, plus any one) (Int)",
            "Speak Language (Ungol) (Int)",
            "Trade (Apothecary or Herbalist) (Int)"
        ],
        "talents": [
            "Aethyric Attunement",
        ...
        "trappings": [
            "Like other hags",
            "hag mothers are talented healers",
            "and they are never without the accoutrements of the trade. A hag mother usually carries an antitoxin kit",
            "an apothecary kit",
            "and at least three healing draughts and healing poultices. Most also have three or more potions (RoS, page 192). To ward away the chill that infiltrates everything",
            "they also are never far from a skin of koumiss. Hag mothers wear the distinctive shawl and often carry walking sticks."
        ],
        "career_entries": [
            "Hag Witch"
        ],
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (History or Spirits) (Int)",
            "Command (Fel)",
            "Common Knowledge (Kislev or Troll Country) (Int)",
            "Consume Alcohol (T) or Perception (Int)",
            "Heal (Int)",
            "Intimidate (S)",
            "Magical Sense (WP)",
            "Prepare Poison (Int) or Trade (Apothecary or Herbalist) (Int)",
            "Speak Arcane Language (Magick) (Int)",
            "Speak Language (Ungol) (Int)"
        ],
        "talents": [
        ...
        "trappings": [
            "Hag witches are gifted healers",
            "so they always have at least one antitoxin kit",
            "a healing draught",
            "a healing poultice",
            "and a skin of koumiss to fight the cold. They are also quite superstitious and",
            "thus",
    ...
    },
    {
        ...
        "description": "(SoE) Those fully initiated into the ancient mysteries of Hedgecraft are called Hedge Masters, although outsiders often know them as Wise Ones or Cunning Folk. Most live on the periphery of the communities they serve, and are known for their healing skills and the potions, tonics, and charms they sell. They lead private lives, keen to avoid those who may take offense at their trade and beliefs, and are generally welcomed by locals for the services they provide. A select few Hedge Masters work directly for their Hedgewise, seeking out and neutralising threats to the Hedgefolk. This is dangerous work, for it often involves direct contact with Witch Hunters and Imperial Magisters to better learn their movements and understand their motivations.",
        "main_profile": {
            "ws": {
                "value": 0,
                "label": "–"
    ...
    },
    {
        ...
        "description": "(Core) A High Priest is the living embodiment of his God’s will in the Old World. They are fairly rare, as few individuals have both the strength of character and the boundless faith it takes to reach such a lofty post. High Priests, with very few exceptions, will operate out of one of the primary centres of their faith. Pilgrims will travel the breadth of the Empire just to speak for a few moments with such a being. High Priests tend to either reject the physical world, retiring to a monastery or embrace the temporal, becoming powerful secular leaders.",
        "main_profile": {
            "ws": {
                "value": 20,
                "label": "+20%"
    ...
    },
    {
        ...
        "description": "(TiT) The rites of Taal demand great physical, emotional, and mental fortitude for its practitioners. Some see the trappings of civilization – cities, courts, and the like – as a failing in the interpretation of Taal’s will. The Horned Hunters are deeply zealous and shun the city. Unlike Taal’s Chosen, the Horned Hunters give up much in the way of a material life. They shun normal clothing and armour and wear animal skins, loincloths, or less. Part of their initiation into this group is to undergo extensive tattooing, covering their chest and face. Horned Hunters prowl the woods both within the Taalbaston and throughout Talabecland and claim allegiance only to Taal. While they lack the fiery rhetoric of most zealots, they are still fervent in their beliefs and believe that conversion comes from actions, rather than words.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "trappings": [
            "Horse archers are warriors all. They wear leather jacks and leggings that often feature good luck charms made from of locks of hair or pieces of lightning-struck metal. Horse archers are also well-armed",
            "as they are equipped with cavalry spears (as demilance)",
            "Kislevite horse bows with quivers containing 20 arrows",
            "20 armour-piercing arrows",
            "and at least 5 screamer and 5 incendiary arrows. They ride Kislevite warhorses equipped with saddles and harnesses and common gear to survive in the oblast",
            "such as saddle bags filled with rations",
            "water skins",
            "and a yurta."
        ],
        "career_entries": [
    ...
    },
    {
        ...
        "skills": [
            "Animal Care (Int)",
            "Charm (Fel) or Consume Alcohol (T)",
            "Charm Animal (Fel)",
            "Evaluate (Int)",
            "Gossip (Fel)",
            "Haggle (Fel)",
        ...
        "trappings": [
            "It wouldn’t do to look shabby when trying to sell goods",
            "so horse copers always have a set of superior clothing. To control their beasts",
            "copers also carry a lasso or whip. In addition",
            "they have a number of horses ready for sale (1d5 of varying quality) and have a bit of coin for bribes",
            "feed",
            "and stabling (1d10 gc)."
        ],
        "career_entries": [
            "Burgher",
            "Drover",
    ...
    },
    {
        ...
        "skills": [
            ...
            "Charm (Fel)",
            "Charm Animal (Fel)",
            "Consume Alcohol (T) or Dodge Blow (Ag)",
            "Drive (S)",
            "Perception (Int)",
            "Ride (Ag)"
        ],
        ...
        "trappings": [
            "The horsemaster naturally rides a Kislevite horse or warhorse equipped with saddle",
            "harness",
            "and at least one saddlebag to carry a grooming kit and extra feed. Horsemasters also find lassos or whips useful",
            "and like most Kislevites",
            "they wear leather jacks and leggings."
        ],
        "career_entries": [
            "Drover",
            "Horse Archer",
    ...
    },
    {
        ...
        "description": "(Core) While the Empire has come far from the tribes that founded it 2500 years ago, some things haven’t changed at all. Although Peasants till parts of the land, huge expanses of the Empire are still covered with forest or are hostile to agriculture. These are the lands where Hunters and trappers thrive. They use the same techniques as their ancestors to take down game, be it a trap or a well-placed shot. It takes skill to stalk wild animals while avoiding the dark creatures of the woods. Hunters in their animal skin clothes and fur hats may appear uncouth to city folks, but they don’t much care what others think of them.",
        "main_profile": {
            "ws": {
                "value": 0,
                "label": "–"
    ...
    },
    {
        ...
        "skills": [
            ...
            "Channelling (WP)",
            "Command (Fel) or Intimidate (S)",
            "Common Knowledge (Kislev) (Int)",
            "Magical Sense (WP)",
            "Navigation (Int) or Read/Write (Int)",
            "Outdoor Survival (Int) or Ride (Ag)",
            "Perception (Int)",
            "Speak Arcane Language (Magick) (Int)",
            "Speak Language (Kislevarin) (Int)"
        ],
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (Magic, plus any one) (Int)",
            "Channelling (WP)",
            "Command (Fel) or Intimidate (S)",
            "Common Knowledge (Kislev, plus any one) (Int)",
            "Magical Sense (WP)",
            "Outdoor Survival (Int) or Ride (Ag)",
            "Perception (Int)",
            "Read/Write (Int)",
            "Speak Arcane Language (Magick) (Int)",
            "Speak Language (Kislevarin, plus any two) (Int)"
        ],
        "talents": [
            "Fast Hands",
            "Lesser Magic (any three)",
        ...
        "trappings": [
            "Ice witches all wear superior winter clothing and often accent their attire with a few bits of jewellery studded with diamonds or sapphires. As well",
            "ice witches carry at least one magic item found during their wanderings as ice maidens."
        ],
        "career_entries": [
            "Ice Maiden"
        ],
    ...
    },
    {
        ...
        "trappings": [
            "Religious Symbol (see Chapter 8: Religion and Belief for types)",
            "Robes"
        ],
        "career_entries": [
            "Cantor",
    ...
    },
    {
        ...
        "description": "(Core) The Empire is a nation of laws, which means it’s also a nation of jails. Despite the best efforts of the clergy of Verena, the Goddess of Justice, the innocent are just as likely as the guilty to end up in jail. Better too harsh than too lax is the opinion of the law. Imperial jails are foul dungeons that smell equally of fear and excrement. Jailers preside over these institutions, using a combination of brutality and humiliation to keep order. Jailers generally have no sense of justice or pity, and are seldom swayed by pleas or speeches (though bribes are gladly accepted). The worst are outright sadists, delighting in the power they hold over their charges.",
        "main_profile": {
            "ws": {
                "value": 10,
                "label": "+10%"
    ...
    },
    {
        ...
        "description": "(NDM) The Fellowship of the Shroud believes in taking the battle to the enemy. Their very best warriors form an order known as the Knights of the Raven, and their mandate is very clear: destroy every Skeleton, Zombie, and Shade upon the earth and exterminate the necromancers and Vampires who summon them. Unlike their sister order the Black Guard, the Knights of the Raven are ruthless and aggressive, seeking out their enemy rather than waiting for Undead to come to them. At the moment, a great many of the knights are stationed in the town of Siegfriedhof of Stirland on the border of Sylvania. So far, they have only conducted raids, but as their numbers and intelligence grows, and the truth about Mannfred’s return becomes undeniable, they will begin a crusade to take that bleak land away from its dark lords once again.",
        "main_profile": {
            "ws": {
                "value": 35,
                "label": "+35%"
        ...
        "skills": [
            "Academic Knowledge (History, Necromancy, Strategy/Tactics",
            "Theology)",
            "Animal Training",
    ...
    },
    {
        ...
        "skills": [
            ...
            "Ride",
            "Search",
            "Speak Arcane Language (Daemonic, Magick)",
            "Speak Language (any two)",
            "Torture"
        ],
        "talents": [
    ...
    },
    {
        ...
        "description": "(KotG) The peasants of Bretonnia try to live their lives without noble interference. When the nobility get involved, people are beaten or hanged and food is taken, only making matters worse. However, the peasantry are far from living in a cooperative idyll, and disputes do arise between villages. Mediators are the peasants chosen to resolve those disputes. They live in one village and deal with the representatives, normally other Mediators, of villages with which they have a dispute. Mediators do not normally have the authority to make decisions, so they must try for a solution they can sell to their neighbours. Most Mediators are officially herders, as this gives them an excuse to be in odd places if the nobility find them. Whilst the overwhelming majority are men, a few female Mediators do exist.",
        "main_profile": {
            "ws": {
                "value": 0,
                "label": "–"
    ...
    },
    {
        ...
        "description": "(Core) The Nobles are the ruling class of the Empire. They wield the power, they control the land, and they make the laws. The most important Noble families are those of Imperial Electors and of course the Emperor himself. There are hundreds of others though, and they all vie for more money and more power. Some seek their fortunes in war, others in business or politics. None would sully themselves by practicing a common trade. The most contemptible Nobles do nothing at all, merely live off their family wealth and attend an endless array of parties, dances, and gala events. The younger children of Noble houses, however, do not have it so easy. Since inheritance goes to the eldest, they must often make their own way in the world, even if it means slumming amongst the lower classes and falling in with adventurers and ne’er-do-wells.",
        "main_profile": {
            "ws": {
                "value": 10,
                "label": "+10%"
    ...
    },
    {
        ...
        "description": "(Core) The peasantry makes up the preponderance of the Empire’s population. While the Nobles rule and the Burghers trade, the Peasants toil. They are farmers, labourers, and herdsman. In times of war, they fight and die for the Empire. Many Peasants seek a better life in the city, only to join the legion of beggars on the verge of starvation. The majority spends their whole lives in the village they were born in, surrounded by hostile country and only occasionally getting news of the outside world. While they are provincial and superstitious, the Peasants are the heart of the Empire.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "skills": [
            "Common Knowledge (Bretonnia, the Empire, Lustria, Norsca, Southlands, Tilea, or the Wasteland)",
            "Consume Alcohol",
            "Dodge Blow",
            "Row",
            "Sail",
    ...
    },
    {
        ...
        "description": "(Core) If Rogues have a creed, it is this: never do an honest day’s work if you can avoid it. These fast-talking con men use their charm and luck to make their way in the world. Some work as bawds, professional guides to the dens of vice and inequity to be found in any city. Others are professional gamblers or raconteurs. All Rogues favour their wits over their swords, and they always have a ready story on their lips. While Rogues often have one city as home turf, some travel from place to place, profiting from elaborate schemes and then moving on. The most skilled Rogues go undetected. Their lies are so convincing that even those they have swindled never realize it was a con.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "description": "(RoS) The Runelords are the greatest of the Runesmiths. A Runelord candidate may only be promoted with the death of an existing Runelord, so this position is highly coveted and contested. Among the Dwarfs, Runelords are equal to kings, and so they move through Dwarf society as some of its most esteemed members. A few Runelords withdraw from the world, sequestering themselves away to learn the deeper secrets of the Master Runes and perhaps create a few of their own, further diminishing their numbers as their names become legend.",
        "requirements": "Note: Only Dwarfs can enter this career.",
        "main_profile": {
            "ws": {
                "value": 20,
    ...
    },
    {
        ...
        "description": "(Core) Sea Captains roam the oceans of the Old World seeking profit and adventure over the next horizon. Strictly honourable Sea Captains are far-travelling traders who only sail in search of the most profitable markets for their goods. The most dangerous are bloodthirsty pirates, attacking other ships for plunder and leaving no survivors. Most Sea Captains fall somewhere in between. On a sea-going vessel a Captain’s word is law. Sailors, however, are a fractious lot; a Sea Captain must be clever, strong-willed and a bit ruthless to stay in command. The most famous Sea Captains come from Marienburg, Tilea, and the Elven island of Ulthuan.",
        "main_profile": {
            "ws": {
                "value": 25,
                "label": "+25%"
    ...
    },
    {
        ...
        "requirements": "Note: Only Dwarfs can have Shieldbreaker as a Starting Career",
        "main_profile": {
            "ws": {
                "value": 10,
                "label": "+10%"
    ...
    },
    {
        ...
        "skills": [
            "Animal Care (Int)",
            "Animal Training (Fel) or Trade (Cook) (Int)",
            "Charm Animal (Fel) or Consume Alcohol (T)",
            "Common Knowledge (Troll Country) (Int)",
            "Concealment (Ag) or Heal (Int)",
            "Follow Trail (Int) or Trade (Bowyer) (Ag)",
            "Navigation (Int) or Secret Signs (Scout) (Int)",
            "Outdoor Survival (Int)",
            "Perception (Int) or Performer (Dancer) (Fel)",
            "Ride (Ag)"
        ],
        "talents": [
            "Hardy or Rover"
        ...
        "trappings": [
            "Steppe nomads are accustomed to the harshness of their environment",
            "so they are equipped accordingly. A sturdy Kislevite horse with saddle and harness laden with at least a week of ration",
            "a few skins of water and koumiss",
            "and a yurta ensure the steppe nomad survives the biting winds and the frigid temperatures. The steppe is also home to ravenous beasts and terrifying monsters",
            "so steppe nomads wear leather jacks and leggings for protection",
            "and all carry at least a Kislevite horse bow with a quiver of 10 arrows."
        ],
        "career_entries": [
            "Any"
        ],
    ...
    },
    {
        ...
        "skills": [
            "Common Knowledge (Kislev) (Int) or Perception (Int)",
            "Consume Alcohol (T)",
            "Dodge Blow (Ag)",
            "Gamble (Int) or Gossip (Fel)",
            "Speak Language (Kislevarin) (Int)"
        ],
        "talents": [
    ...
    },
    {
        ...
        "description": "(Core) Targeteers dedicate themselves to perfecting their skill with missile weapons, most often the mighty longbow, though a rare few prefer the crossbow. They regularly travel to different fairs, delighting crowds with their trick shooting and pitting their skills against all-comers in impromptu contests. Many Nobles regularly hold archery tourneys with a fair purse to the winner and a professional Targeteer can make a decent living if he is skilled enough to regularly claim a prize or two. In these grim times, a Targeteer’s uncanny skill with a bow is in high demand among armies and Mercenary companies.",
        "main_profile": {
            "ws": {
                "value": 0,
                "label": "–"
    ...
    },
    {
        ...
        "description": "(Core) Tradesmen are skilled labourers and craftsmen. Although they tend to cluster together in cities, they can also be found in villages across the Empire. They provide many of the goods used by Merchants when trading abroad, and are valued as an important part of the Empire’s economy. Tradesmen include apothecaries, armourers, bowyers, brewers, calligraphers, carpenters, cartographers, gem cutters, gunsmiths, herbalists, peddlers, shipwrights, smiths, stoneworkers, tailors, and weaponsmiths. Each trade has its own guild, though not all guilds have local chapters.",
        "main_profile": {
            "ws": {
                "value": 0,
                "label": "–"
    ...
    },
    {
        ...
        "description": "(Core) Dwarfs who have been disgraced, crossed in love, or otherwise humiliated abandon traditional society and seek the sweet release of death. They hunt the most dangerous of monsters in the hopes of finding a glorious end. Most of them die fairly quickly, but those few who survive become members of the strange cult of Troll Slayers. They exist only to die, and by doing so redeem whatever disgrace they suffered in the past. They seek the fiercest foes, and Trolls are considered ideal because the Dwarfs’ deaths are almost a certainty. Troll Slayers are instantly recognizable, with their spiky orange hair, outlandish tattoos, and gaudy jewellery. They spend a great deal of time boasting of their exploits and show off their many scars, and often indulge in bouts of overeating, drunkenness, and sleep deprivation.",
        "requirements": "Note: Only Dwarfs can join this career. Taking the Slayer’s path is a sure route to death. Think carefully before entering this career.",
        "main_profile": {
            "ws": {
                "value": 10,
                "label": "+10%"
    ...
    },
    {
        ...
        "skills": [
            ...
            "Navigation",
            "Outdoor Survival",
            "Performer (Dancer, Singer, or Storyteller) or Secret Signs (Ranger or Thief)",
            "Silent Move"
        ],
        "talents": [
    ...
    },
    {
        ...
        "description": "(Core) Vampire Hunters are driven souls who seek to destroy the Undead by any means necessary. Many of them have lost friends and family members to the Restless Dead, most often to their namesake. Since any but the most cursory knowledge of the Undead is a forbidden subject in the Empire, Vampire Hunters are a self-made lot. They congregate quietly with others of their ilk; sharing what little knowledge they’ve gleaned from their more successful encounters with the forces of the Restless Dead in hopes of one day finding a sure method of killing vampires.",
        "main_profile": {
            "ws": {
                "value": 20,
                "label": "+20%"
    ...
    },
    {
        ...
        "description": "(ToC) Warleaders are proven Norsemen warriors who’ve seen countless battles and are entrusted by their Jarls and Kings to lead detachments of other warriors and Marauders against their enemies. Typically, Warleaders bear many strange tattoos, ritual scars, and most, if not all, have one or more mutations, showing they have the favour of the Gods.",
        "main_profile": {
            "ws": {
                "value": 20,
                "label": "+20%"
    ...
    },
    {
        ...
        "description": "(RoS) Witches that use Dark Magic and embrace its power can become Warlocks if they survive its perils long enough to gain the required knowledge. They may not realize it at first, but this is a dangerous path that leads almost inevitably to corruption. They are the bogeymen of the witch hunters, the spellcasters that are a danger to themselves and to others. Warlocks tend to be either Daemonologists or Necromancers. Since they are self- taught and so much of their magic is based on experimentation, however, most Warlocks have unique views of magic and the world. It is this individuality that makes it so hard for the witch hunters to root them out.",
        "requirements": "Note: You must have at least one insanity point and learned at least two spells through your Witchcraft talent before you can enter this career.",
        "main_profile": {
            "ws": {
                "value": 10,
                "label": "+10%"
    ...
    },
    {
        ...
        "description": "(ToC) Whaling is an important trade for Norsca, and Whalers are respected even among the warriors. Swimming through the dark currents of the Sea of Chaos are massive whales, many of which bear strange markings, and odd colouration, twisted and warped as they are by the power of Chaos. These monsters can capsize ships and swallow hundreds of men in a single gulp. Thus, Whalers must be made of sterner stuff than ordinary fishermen.",
        "main_profile": {
            "ws": {
                "value": 5,
                "label": "+5%"
    ...
    },
    {
        ...
        "skills": [
            "Academic Knowledge (Strategy/Tactics) (Int)",
            "Animal Care (Int) or Dodge Blow (Ag)",
            "Command (Fel) or Navigation (Int)",
            "Common Knowledge (Kislev or Troll Country) (Int)",
            "Consume Alcohol (T)",
            "Outdoor Survival (Int)",
        ...
        "trappings": [
            "Winged lancers are fearsome warriors",
            "and they dress the part. All winged lancers have at least full suits of mail",
            "though some accent their armour with bits of plate. From their backs fly winged banners. In battle",
            "they thunder across the field",
            "riding Kislevite warhorses equipped with saddles and harnesses. For arms",
            "they carry lances",
            "scimitars (Hand Weapons)",
            "shields",
            "and at least two javelins. Finally",
            "such heroes keep a bottle of kvas to help them through the icy nights."
        ],
        "career_entries": [
            "Horse Master",
            "Kislevite Kossar",
    ...
    },
    {
        ...
        "description": "(Core) Within the Empire, the Lords of the Magical Orders are powerful individuals indeed. They no longer see the world as others do, however, having dedicated their very souls to magic. They now embody their chosen Lore in word, deed and physical form. Should an Elf attain this level of magical skill, he is considered to have completed his minor magic apprenticeship, and is ready to travel to the towers of Hoeth to become a High Mage. Note: Wizard Lords no longer pay dues to their Order. They are, however, charged with preserving the purity of their order, rooting out Chaos worshippers, and ensuring the Orders receive the respect (and monies) due to them.",
        "main_profile": {
            "ws": {
                "value": 15,
                "label": "+15%"
...
const talents = [
    ...
    {
        "name": "Master Rune",
        "description": "You have learned the secrets of a magical master rune, the most powerful type of rune. Master Rune is unusual in that it is not one talent but many, and each must be acquired individually. Each Master Rune talent is a separate proficiency, with its name noted in parenthesis. For example, Master Rune (Alaric the Mad) is a different talent than Master Rune (Adamant)."
    },
    {
        "name": "Meditation",
    ...
    {
        "name": "Rune",
        "description": "Description: You have learned the secrets of a magical rune. Rune is unusual in that it is not one talent but many, and each must be acquired individually. Each Rune talent is a separate proficiency, with its name noted in parenthesis. For example, Rune (Fury) is a different talent than Rune(Speed)."
    },
    {
        "name": "Savvy",
    ...
    {
        "name": "Witchcraft",
        "description": "You have managed to survive the perils of hedge wizardry and teach yourself more powerful techniques of magic use. This gives you access to spells beyond Petty Magic but since you must figure out each spell on your own, your progress is slower than that of a Magister. Witchcraft allows you to learn any spell from an Arcane Lore with a Casting Number of 15 or less, but you must pay 200 xp for cach one. You can cast these spells without having the Speak Arcane Language skill. However, you must roll an extra d10 when casting one of these spells. This does not add into your Casting Roll but does count for the purposes of Tzeentch's Curse. Once you learn an Arcane Language and an Arcane’ Loge, you no longer have to roll the extra die."
    },
    {
        "name": "Wrestling",
...
const chars = [
    {
        "name": "Varies",
        "short": "Var",
        "description": "Placeholder for charateristic for Trade Skill"
    },
    {
        "name": "Weapon Skill",
        "short": "WS",
        "description": "Represents your character's skill in hand-to-hand combat, both with weapons and without."
    },
    {
        "name": "Ballistic Skill",
        "short": "BS",
        "description": "Represents your character's skill with missile weapons, such as bows, crossbows, and pistols."
    },
    {
        "name": "Strength",
        "short": "S",
        "description": "Represents your character's muscle and brawn."
    },
    {
        "name": "Toughness",
        "short": "T",
        "description": "Represents your character's ability to withstand injury, disease, and poison."
    },
    {
        "name": "Agility",
        "short": "Ag",
        "description": "Represents physical quickness, manual dexterity, and reaction speed."
    },
    {
        "name": "Intelligence",
        "short": "Int",
        "description": "Represents your character's intellect, insight, and ability to reason."
    },
    {
        "name": "Will Power",
        "short": "WP",
        "description": "Represents your character's mental toughness and resolve."
    },
    {
        "name": "Fellowship",
        "short": "Fel",
        "description": "Represents your character's personal charisma and social skills."
    },
    {
        "name": "Attacks",
        "short": "A",
        "description": "Represents the quickness of your character's attacks and indicates the maximum number of attacks you can make in 10 seconds."
    },
    {
        "name": "Wounds",
        "short": "W",
        "description": "Represents your character's general vitality and how much damage they can suffer before becoming critically injured."
    },
    {
        "name": "Strength Bonus",
        "short": "SB",
        "description": "Derived from Strength. Used when inflicting damage in melee combat."
    },
    {
        "name": "Toughness Bonus",
        "short": "TB",
        "description": "Derived from Toughness. Used to resist damage."
    },
    {
        "name": "Movement",
        "short": "M",
        "description": "Represents your character's base land speed."
    },
    {
        "name": "Magic",
        "short": "Mag",
        "description": "Represents your character's magical power."
    },
    {
        "name": "Insanity Points",
        "short": "IP",
        "description": "Represents the state of your character's sanity. PCs begin with 0 but can gain them due to horrific experiences or grievous wounds."
    },
    {
        "name": "Fate Points",
        "short": "FP",
        "description": "Represents luck and, to an extent, your character's destiny. Can be used to avoid certain death."
    },
];
...
const skills = [
    ...
    },
    {
        ...
        "description": "Use this skill to control the Winds of Magic. All spellcasting involves manipulations of the Winds of Magic, but Channelling is used whenever greater finesse or control is needed. For more on the process of spellcasting and the role of Channelling, see Chapter 7: Magic.",
        "relatedTalents": "Aethyric Attunement"
    },
    {
        "name": "Charm",
        "isBasic": true,
        ...
        "relatedTalents": "Etiquette, Master Orator, Public Speaking, Schemer, Streetwise"
    },
    {
        "name": "Charm Animal",
        "isBasic": true,
    ...
    },
    {
        ...
        "relatedTalents": "Seasoned Traveller"
    },
    {
        "name": "Concealment",
        "isBasic": true,
        ...
        "relatedTalents": "Alley Cat, Rover, Tunnel Rat"
    },
    {
    ...
    },
    {
        ...
        "relatedTalents": "Artistic, Dealmaker"
    },
    {
        "name": "Follow Trail",
        "isBasic": false,
    ...
    },
    {
        ...
        "relatedTalents": "Etiquette, Streetwise"
    },
    {
        "name": "Haggle",
        "isBasic": true,
    ...
    },
    {
        ...
        "isAdvanced": false,
        "characteristic": "Strength",
        "description": "Use this skill to coerce or frighten others. Victims of intimidation may resist with a successful Will Power Test. How NPCs react to intimidation is ultimately up to the GM, bearing in mind the character's personality and the results of the test. Under certain circumstances (blackmail, etc.), the GM may allow Intimidate Tests that are based on Fellowship instead of Strength.",
        "relatedTalents": "Menacing"
    },
    {
        "name": "Lip Reading",
        "isBasic": false,
        ...
        "relatedTalents": "Excellent Vision"
    },
    {
        "name": "Magical Sense",
        "isBasic": false,
    ...
    },
    {
        ...
        "relatedTalents": "Acute Hearing, Excellent Vision, Super Numerate, Trapfinder"
    },
    {
        "name": "Performer",
        "isBasic": false,
        ...
        "relatedTalents": "Contortionist, Mimic"
    },
    {
        "name": "Pick Locks",
        "isBasic": false,
        "isAdvanced": true,
        "characteristic": "Agility",
        "description": "Use this skill to open locks. Usually, one successful Skill Test is all that's required to pick a lock, but GMs may call for extra tests for extremely complicated locks. This skill can also be used to disarm mechanical traps.",
        "relatedTalents": "Trapfinder"
    },
    {
        "name": "Prepare Poison",
        "isBasic": false,
    ...
    },
    {
        ...
        "isAdvanced": true,
        "characteristic": "Will Power",
        "description": "Use this skill to empower magical runes. Runecraft is the basis of the Runesmith's abilities. It allows you to trap magical power inside a rune and create enchanted items. See page 210 for further details on creating runes. Note this skill is not used to identify unknown runes. That is covered by Academic Knowledge (Runes).",
        "relatedTalents": "None"
    },
    {
        "name": "Sail",
    ...
    },
    {
        ...
        "isAdvanced": true,
        "characteristic": "Intelligence",
        "description": "Use this skill to read or leave coded messages. Several common sets of signs are in use in the Empire. Secret signs are not very sophisticated, mostly being used to warn of danger, mark a target, indicate protection, and so on. Skill tests are not required to read basic messages but may be necessary to decipher complicated messages or worn or damaged signs. Like Academic Knowledge, Secret Signs isn't one skill but many. The most common Secret Signs are Scout, Templar, Thief, and Ranger.",
        "relatedTalents": "None"
    },
    {
        "name": "Set Trap",
    ...
    {
        "name": "Speak Arcane Language",
        "isBasic": false,
        "isAdvanced": true,
        "characteristic": "Intelligence",
        "description": "Use this skill to cast spells and chant runes. You must speak an arcane language in order to use magic. Unlike other languages, arcane languages aren't used for common conversation, but to manipulate magical energies. All scrolls and grimoires are written in an arcane language. Like Academic Knowledge, Speak Language isn't one skill but many. The most common arcane languages are Magick (known as Lingua Praestantia amongst Imperial magisters), Daemonic, Arcane Elf and Arcane Dwarf.",
        "relatedTalents": "None"
    },
    {
        "name": "Speak Language",
    ...
    },
    {
        ...
        "relatedTalents": "Artistic, Dwarfcraft"
    },
    {
        "name": "Ventriloquism",
        "isBasic": false,
